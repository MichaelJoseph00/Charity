            ...
            <div class="container px-4 px-lg-5 ">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                        ...
                        <li class="nav-item"><a class="nav-link" aria-current="page" href="volunteer.php">Volunteer</a></li>
                ...
                <button class="btn btn-flat btn-primary" type="button" id="donation">Donate Money</button>
                <button class="btn btn-flat btn-primary" type="button" id="donation1">Donate Items</button>
...
<script>
  $(function(){
    ...
    $('#donation1').click(function(){
      uni_modal('Donation','donate1.php')
    })
  })
</script>